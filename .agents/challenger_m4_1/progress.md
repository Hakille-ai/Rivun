...
- [x] Executed base test commands:
  - `cargo test -p zap-agent -p zap-gateway --all-targets` (PASSED: 45 passed, 0 failed)
  - `cargo clippy --workspace --all-targets -- -D warnings` (FAILED: 4 clippy errors in `crates/zap-gateway`)
