...
## Mission
Investigate detailed architecture and concrete design for `crates/zap-runtime` (async_engine, streaming, ipc, pipeline) for Milestone 3.

## 🔒 My Identity
- Archetype: explorer
- Roles: explorer, investigator, synthesizer
- Working directory: c:\Users\Stagiaire\Documents\Amadou PGC\Prs\ZAP\.agents\sub_orch_m3_explorer_3
...
- Explore zap-runtime (async_engine, streaming, ipc, pipeline) and zap-wasm-engine interactions
...
## Investigation State
- **Explored paths**:
  - `crates/zap-runtime/src/lib.rs` (WasmExecutor, StoreState, host imports, limits)
  - `crates/zap-runtime/src/pipeline.rs` (compilation defect with WasmActionRuntime, DriverPipeline)
  - `crates/zap-driver-sdk/src/lib.rs` (ABI, ZapDriver, packed result)
  - `crates/zap-capability/src/lib.rs` (DriverPermissions, capabilities)
  - `crates/zap-node/src/lib.rs` (uses WasmExecutor)
...
- **Unexplored areas**: None for M3 zap-runtime scope.
