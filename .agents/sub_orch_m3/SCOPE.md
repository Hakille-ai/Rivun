...
|---|------|-------|-------------|--------|
| M3.1 | rivun-driver-sdk async & zero-copy | AsyncZapDriver, PinnedBuffer, IPC traits | M1, M2 | IN_PROGRESS |
| M3.2 | rivun-runtime async engine | Non-blocking async host runtime on Tokio | M3.1 | IN_PROGRESS |
| M3.3 | rivun-runtime streaming & ring-buffers | Streaming buffers, TCP/Modbus/Ring | M3.1 | IN_PROGRESS |
| M3.4 | rivun-runtime IPC & DriverPipeline | Inter-driver IPC, multi-stage DriverPipeline, fuel budgeting | M3.2, M3.3 | IN_PROGRESS |
