...
- [x] Scanned directory tree of `crates/zap-agent` and discovered absence of `crates/zap-gateway`
...
- [x] Ran existing tests in `zap-agent` (9 unit tests + 6 fixture tests pass)
