...
## Mission
Implement the comprehensive, requirement-driven, opaque-box E2E test suite (Tiers 1-4) for all 15 features of rivun Next-Gen Frontier, update TEST_INFRA.md and TEST_READY.md, and ensure 100% test pass.
...
- Milestone: rivun Next-Gen Frontier E2E Testing Generation 2
...
- All tests must pass cleanly (`cargo test --package rivun-e2e`).
...
- **Success criteria**: All 15 features tested with >= 5 Tier 1 feature tests each (75+), >= 5 Tier 2 boundary tests each (75+), >= 15 Tier 3 cross-feature combinations, >= 8 Tier 4 real-world scenarios. All tests pass in `cargo test --package rivun-e2e`. `TEST_INFRA.md` & `TEST_READY.md` up-to-date.
