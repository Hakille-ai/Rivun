...
## Review Scope
- **Files to review**: `crates/zap-telemetry`, `crates/zap-node`, `crates/zap-cli`, `tests/e2e/tests/e2e_suite.rs` (tc_f06, tc_f07, tc_f08)
...
- **Hypotheses tested**:
  ...
  6. Prometheus text exposition format emits all standard headers and counters, including atomic increment of `zap_replay_drops_total`. (Confirmed passing)
