...
1. Run `cargo test -p rivun-telemetry -p rivun-node -p rivun-cli` and `cargo test --test e2e tc_f06 tc_f07 tc_f08`.
...
3. Test Prometheus metrics format and counter atomic increments (`@@rivun_HEADER@@replay_drops_total`).
