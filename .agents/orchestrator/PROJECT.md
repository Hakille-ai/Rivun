...
| M1 | R1: P2P Swarm Gossip & Quorum Mesh | `crates/rivun-net`, `crates/rivun-agent`, `crates/rivun-node` | none | PLANNED |
| M2 | R2: MMR & Compact Cryptographic Receipts | `crates/rivun-ledger`, `crates/rivun-crypto` | none | PLANNED |
| M3 | R3: Async WASM Driver Pipeline & IPC | `crates/rivun-runtime`, `crates/rivun-driver-sdk` | none | PLANNED |
| M4 | R4: Decentralized Agent Pact & Dispute Engine | `crates/rivun-pact`, `crates/rivun-policy`, `crates/rivun-agent` | M1, M2 | PLANNED |
| M5 | R5: Cluster Simulator & Swarm Tooling | `crates/rivun-cli`, `crates/rivun-telemetry`, `benches/`, `tests/` | M1, M2, M3, M4 | PLANNED |
