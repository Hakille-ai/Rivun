    ...
    PromptsListResult {
        prompts: vec![
            PromptDescriptor {
                ...
                description: "Decompose a high-level goal into structured deterministic Rivun agent actions and constraints.".to_string(),
                arguments: vec![
                    PromptArgument {
            ...
            PromptDescriptor {
                ...
                description: "Generate structured deterministic action plan for Rivun AI agent execution.".to_string(),
                arguments: vec![
                    PromptArgument {
                        name: "objective".to_string(),
...
pub fn get_prompt(params: PromptGetParams) -> Result<PromptGetResult> {
    match params.name.as_str() {
        "goal_decomposition" | "agent_action_plan" => {
            ...
            Ok(PromptGetResult {
                description: "Rivun Goal Decomposition & Action Plan Template".to_string(),
                messages: vec![PromptMessage {
                    role: "system".to_string(),
                    content: ToolContent {
                        content_type: "text".to_string(),
                        text: format!(
                            "You are a deterministic Rivun AI Agent. Goal: {objective}. Ensure all subtasks have explicit capabilities, required constraints, and signed receipt verification."
                        ),
                    },
                }],
            })
        ...
        "capability_negotiation" => {
            ...
            Ok(PromptGetResult {
                description: "Rivun Capability Negotiation Template".to_string(),
                messages: vec![PromptMessage {
                    role: "system".to_string(),
                    content: ToolContent {
                        content_type: "text".to_string(),
        ...
        "safe_execution_verification" | "policy_check" => {
            ...
            Ok(PromptGetResult {
                description: "Rivun Safe Execution Verification Template".to_string(),
                messages: vec![PromptMessage {
                    role: "system".to_string(),
                    content: ToolContent {
                        content_type: "text".to_string(),
        ...
        "incident_diagnostics" => Ok(PromptGetResult {
            description: "Rivun Incident Diagnostics Template".to_string(),
            messages: vec![PromptMessage {
                role: "system".to_string(),
                content: ToolContent {
                    content_type: "text".to_string(),
        ...
        other => Err(RivunGatewayError::NotFound(format!(
