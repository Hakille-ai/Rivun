...
use rivun_node::durable_replay::DurableReplayStore;
...
fn stress_test_replay_store_clock_jumps_and_overflow() {
    ...
    let frame_future = RivunFrame::with_timestamp(
        source,
        target,
        RivunFlags::ENCRYPTED,
    ...
    let frame_past = RivunFrame::with_timestamp(
        source,
        target,
        RivunFlags::ENCRYPTED,
    ...
    let frame_overflow = RivunFrame::with_timestamp(
        source,
        target,
        RivunFlags::ENCRYPTED,
        u64::MAX,
...
fn stress_test_replay_store_partial_write_corruption() {
    ...
    let frame1 = RivunFrame::with_timestamp(
        source,
        target,
        RivunFlags::ENCRYPTED,
        base_now,
    ...
    let frame2 = RivunFrame::with_timestamp(
        source,
        target,
        RivunFlags::ENCRYPTED,
        base_now + 100,
