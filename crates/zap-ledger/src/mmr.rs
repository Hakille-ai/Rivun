//! Merkle Mountain Range (MMR) Accumulator for ZAP Receipts.
//!
...
pub const MMR_LEAF_DOMAIN: &[u8] = b"ZAP-MMR-LEAF-v1:";
pub const MMR_NODE_DOMAIN: &[u8] = b"ZAP-MMR-NODE-v1:";
pub const MMR_PEAK_BAG_DOMAIN: &[u8] = b"ZAP-MMR-PEAK-BAG-v1:";
